...
";
    ...
    class PlayerInfo
    {
        public class PlayerBaseStats
        {
            ...
            public static PlayerBaseStats knight = new PlayerBaseStats("Knight", 100, 25, 10, 120);
            public static PlayerBaseStats mage = new PlayerBaseStats("Mage", 80, 18, 7, 150);
            public static PlayerBaseStats archer = new PlayerBaseStats("Archer", 60, 20, 6, 100);
            public static PlayerBaseStats bard = new PlayerBaseStats("Bard", 60, 15, 6, 100);
    ...
    class MonsterInfo
    {
        public class MonsterBaseStats
        {
            ...
            public static MonsterBaseStats slime = new MonsterBaseStats("Slime", 60, 18, 9);
            public static MonsterBaseStats goblin = new MonsterBaseStats("Goblin", 100, 22, 10);
            public static MonsterBaseStats skeleton = new MonsterBaseStats("Skeleton", 80, 20, 7);
            public static MonsterBaseStats revenant = new MonsterBaseStats("Revenant", 60, 18, 9);
            public static MonsterBaseStats gargoyle = new MonsterBaseStats("Gargoyle", 100, 22, 10);
            public static MonsterBaseStats wraith = new MonsterBaseStats("Wraith", 80, 20, 7);
        }
        ...
        public class DefinedMonsterPool
        {
            ...
            public static MonsterBaseStats[] fiveToTen =
                { MonsterBaseStats.revenant, MonsterBaseStats.gargoyle, MonsterBaseStats.wraith };
        }
    ...
    class BossInfo
    {
        public class BossBaseStats
        {
            ...
            public static BossBaseStats megalodon = new BossBaseStats("Megalodon", 1500, 80, 50, 10);
            public static BossBaseStats leviathan = new BossBaseStats("Leviathan", 2500, 130, 100, 15);
    ...
    class ItemInfo
    {
        public class ItemStats
        {
            ...
            public static ItemStats atkPotion = new ItemStats("Attack Boost Potion","Boosts ATK for selected player", 20, atkValue: 25);
            public static ItemStats defPotion = new ItemStats("Defense Boost Potion","Boosts DEF for selected player", 20, defValue: 25);
    ...
    class SkillInfo
    {
        public class SkillBaseStats
        {
            ...
            public static SkillBaseStats superSlash = 
                new SkillBaseStats("Super Slash", "Deals damage to selected monster", 120, hpValue: 250);
            ...
            public static SkillBaseStats blizzard =
                new SkillBaseStats("Blizzard", "Deals AOE damage to monsters", 70, hpValue: 60, aoe: true);
            public static SkillBaseStats thunderbolt =
                new SkillBaseStats("Thunderbolt", "Deals damage to selected monster", 100, hpValue: 200);
            
            //Archer
            public static SkillBaseStats arrowRain = 
                new SkillBaseStats("Arrow Rain", "Deals AOE damage to monsters", 90, hpValue: 75, aoe: true);
            public static SkillBaseStats cleanKill =
                new SkillBaseStats("Clean Kill",
                    "Kill selected enemy instantly if its HP is less than specified percent. If not, deal damage instead",
                    100, hpValue: 150, percentageKill: 25);
            
            //Bard
            public static SkillBaseStats encore =
                new SkillBaseStats("Encore", "Boost ATK to all party members", 100, atkValue: 25, offensive: false, aoe: true);
            public static SkillBaseStats remedy =
                new SkillBaseStats("Remedy", "Heals to all party members", 100, hpValue: 25, offensive: false, aoe: true);
    ...
    class BossSkillInfo
    {
        public class SkillBaseStats
        {
            ...
            public static SkillBaseStats fang =
                new SkillBaseStats("Fang of The End", "Deals 'megalodon' damage to random member", hpValue: 300, aoe: false);
